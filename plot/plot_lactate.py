...
ax_gasf.set_xticks(np.arange(0,117,25))
ax_gasf.set_yticks(np.arange(0,117,25))
...
ax_gasf.set_xticks(np.arange(0,23,5))
ax_gasf.set_yticks(np.arange(0,23,5))
plt.yticks(fontproperties = 'Times New Roman')
plt.xticks(fontproperties = 'Times New Roman')
...
ax_gasf.imshow(train_data_mtf[0], cmap='rainbow', origin='upper',)
ax_gasf.set_xticks(np.arange(0,20,5))
ax_gasf.set_yticks(np.arange(0,20,5))
plt.yticks(fontproperties = 'Times New Roman')
plt.xticks(fontproperties = 'Times New Roman')
...
ax_gasf.imshow(train_data_mtf[0], cmap='rainbow', origin='upper',)
ax_gasf.set_xticks(np.arange(0,12,3))
ax_gasf.set_yticks(np.arange(0,12,3))
plt.yticks(fontproperties = 'Times New Roman')
plt.xticks(fontproperties = 'Times New Roman')
...
plt.savefig("lactate.png", dpi=600,format="png")
plt.show()
