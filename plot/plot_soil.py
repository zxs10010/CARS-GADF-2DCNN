...
ax_gasf.set_xticks(np.arange(0,1050,250),)
ax_gasf.set_yticks(np.arange(0,1050,250))
...
ax_gasf.set_xticks(np.arange(0,93,20))
ax_gasf.set_yticks(np.arange(0,93,20))
plt.yticks(fontproperties = 'Times New Roman')
plt.xticks(fontproperties = 'Times New Roman')
...
ax_gasf.imshow(train_data_mtf[0], cmap='rainbow', origin='upper',)
ax_gasf.set_xticks(np.arange(0,28,5))
ax_gasf.set_yticks(np.arange(0,28,5))
plt.yticks(fontproperties = 'Times New Roman')
plt.xticks(fontproperties = 'Times New Roman')
